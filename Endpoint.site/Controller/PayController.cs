...
namespace EndPoint.Site.Controllers
{
    ...
    public class PayDetailController : Controller
    {
        ...
        public PayDetailController(IAddRequestPayService addRequestPayService
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (cart.Data.SumAmount > 0)
            {
                ...
                {
                    Mobile = "09121112222",
                    CallbackUrl = $"https://localhost:7212/Pay/Verify?guid={requestPay.Data.guid}",
        ...
        public async Task<IActionResult> Verify(Guid guid, string authority, string status)
        {
            ...
            {              
                TempData["Warning"] = "پرداخت ناموفق بود.";
                return RedirectToAction("Index", "Cart");
            }
